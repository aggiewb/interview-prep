...
Elements added to a queue are pushed to the tail, or the end, of the queue, and only the element at the front of the queue 
...
and the dequeue method removes and returns the element at the front of the queue. 
